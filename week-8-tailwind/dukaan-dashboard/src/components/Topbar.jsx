export const Topbar = () => {
    return <div className="grid grid-cols-3 items-center gap 4 h-16">
        ...
        <div className="bg-black-100 w-96 h-10 rounded flex items-center">
            ...
            <form action="" className='w-full'>
                <input placeholder='Search features, tutorials, etc.' type="text" className='w-full bg-inherit text-base' />
            </form>
        </div>
